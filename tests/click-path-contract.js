...
const surfaces = [
  ...
  },
  {
    ...
    checks: [
      ...
      ['onClick={() => openDraftPlayer(r.pid)}', 'draft rows open player detail'],
      ["onKeyDown={e => { if (e.key === 'Enter' || e.key === ' ') { e.preventDefault(); openDraftPlayer(r.pid); } }}", 'draft rows support keyboard activation'],
