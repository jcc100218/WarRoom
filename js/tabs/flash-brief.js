...
function IntelligenceBriefWidget({
  ...
  sleeperUserId,
    ...
    const tierMsg = !rosterState.isUsable ? 'Roster sync incomplete. I paused roster, trade, waiver, and league-rank recommendations until player IDs finish loading.'
    ...
    if (!rosterState.isUsable) {
        actions.push({
            icon: '↻', tab: 'myteam',
            title: 'Re-sync roster data before making a move.',
